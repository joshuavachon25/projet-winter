...
**** Évolution du nombre de prisonniers selon les rapports d'inspections (1867-1913)
...
**** Répartition des prisonniers selon leur genre d'après les rapports d'inspections (1867-1915)

Le nombre d'hommes détenus est largement supérieur à celui des femmes, peu importe la prison ou l'année à l'étude.

**** Comparaison du nombre de prisonniers adultes et mineurs selon les rapports d'inspections (1867-1915)

Pour chacune des prisons, le nombre d'adultes incarcérés dépasse de façon impressionnante celui des mineurs.

**** Répartition des prisonniers selon leur dénomination religieuse d'après les rapports d'inspection (1867-1915)
